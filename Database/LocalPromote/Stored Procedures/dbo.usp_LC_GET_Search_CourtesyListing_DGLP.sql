...
CREATE PROCEDURE [dbo].[usp_LC_GET_Search_CourtesyListing_DGLP]
...
SELECT DISTINCT
	...
	,listingDeletionRequested = case when exists (select 1 from LocalPromote.dbo.tblCC_acxListing acx 
												...
												and acx.sConfirm = ''N'' 
												and acx.RID = listingStoreMaster..acx_tbl_listing.RID) 
								then ''Y'' 
								else ''N'' end
...
GO
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Search_CourtesyListing_DGLP] TO [iisLpAdminFull]
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Search_CourtesyListing_DGLP] TO [iisLpAdminSsUiFull]
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Search_CourtesyListing_DGLP] TO [iisReviewEngine]
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Search_CourtesyListing_DGLP] TO [iisReviewEngineFull]
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Search_CourtesyListing_DGLP] TO [lcssui]
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Search_CourtesyListing_DGLP] TO [LocalConnect]
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Search_CourtesyListing_DGLP] TO [web_user]
GO
