...
CREATE PROCEDURE [dbo].[usp_LC_GET_Account_Summary]
@lMemberID int
AS
SET NOCOUNT ON
...
GO
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Account_Summary] TO [iisLpAdminFull]
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Account_Summary] TO [iisLpAdminSsUiFull]
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Account_Summary] TO [iisReviewEngine]
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Account_Summary] TO [iisReviewEngineFull]
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Account_Summary] TO [lcssui]
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Account_Summary] TO [LocalConnect]
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Account_Summary] TO [web_user]
GO
