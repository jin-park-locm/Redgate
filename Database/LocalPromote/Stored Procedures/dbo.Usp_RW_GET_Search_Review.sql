...
CREATE PROCEDURE [dbo].[Usp_RW_GET_Search_Review]
@lReviewID			int				=	NULL,
...
*/
GO
GRANT EXECUTE ON  [dbo].[Usp_RW_GET_Search_Review] TO [iisLpAdminFull]
GRANT EXECUTE ON  [dbo].[Usp_RW_GET_Search_Review] TO [iisLpAdminSsUiFull]
GRANT EXECUTE ON  [dbo].[Usp_RW_GET_Search_Review] TO [iisReviewEngine]
GRANT EXECUTE ON  [dbo].[Usp_RW_GET_Search_Review] TO [iisReviewEngineFull]
GRANT EXECUTE ON  [dbo].[Usp_RW_GET_Search_Review] TO [lcssui]
GRANT EXECUTE ON  [dbo].[Usp_RW_GET_Search_Review] TO [LocalConnect]
GRANT EXECUTE ON  [dbo].[Usp_RW_GET_Search_Review] TO [web_user]
GO
