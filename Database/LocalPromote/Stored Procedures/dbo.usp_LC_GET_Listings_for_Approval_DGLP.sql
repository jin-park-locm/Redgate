...
CREATE PROCEDURE [dbo].[usp_LC_GET_Listings_for_Approval_DGLP]  
...
EXEC (@sql)
GO
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Listings_for_Approval_DGLP] TO [iisLpAdminFull]
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Listings_for_Approval_DGLP] TO [iisLpAdminSsUiFull]
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Listings_for_Approval_DGLP] TO [iisReviewEngine]
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Listings_for_Approval_DGLP] TO [iisReviewEngineFull]
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Listings_for_Approval_DGLP] TO [lcssui]
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Listings_for_Approval_DGLP] TO [LocalConnect]
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Listings_for_Approval_DGLP] TO [web_user]
GO
