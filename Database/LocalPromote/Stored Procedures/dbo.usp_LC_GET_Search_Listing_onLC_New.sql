...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[usp_LC_GET_Search_Listing_onLC_New]  
...
GO
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Search_Listing_onLC_New] TO [iisLpAdminFull]
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Search_Listing_onLC_New] TO [iisLpAdminSsUiFull]
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Search_Listing_onLC_New] TO [iisReviewEngine]
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Search_Listing_onLC_New] TO [iisReviewEngineFull]
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Search_Listing_onLC_New] TO [lcssui]
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Search_Listing_onLC_New] TO [LocalConnect]
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Search_Listing_onLC_New] TO [web_user]
GO
