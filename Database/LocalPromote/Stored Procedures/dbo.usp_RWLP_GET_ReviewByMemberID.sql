...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[usp_RWLP_GET_ReviewByMemberID]
/**********************************************************************************
...
GO
GRANT EXECUTE ON  [dbo].[usp_RWLP_GET_ReviewByMemberID] TO [iisLpAdminFull]
GRANT EXECUTE ON  [dbo].[usp_RWLP_GET_ReviewByMemberID] TO [iisLpAdminSsUiFull]
GRANT EXECUTE ON  [dbo].[usp_RWLP_GET_ReviewByMemberID] TO [iisReviewEngine]
GRANT EXECUTE ON  [dbo].[usp_RWLP_GET_ReviewByMemberID] TO [iisReviewEngineFull]
GRANT EXECUTE ON  [dbo].[usp_RWLP_GET_ReviewByMemberID] TO [lcssui]
GRANT EXECUTE ON  [dbo].[usp_RWLP_GET_ReviewByMemberID] TO [LocalConnect]
GRANT EXECUTE ON  [dbo].[usp_RWLP_GET_ReviewByMemberID] TO [web_user]
GO
