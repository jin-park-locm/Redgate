...
create PROCEDURE [dbo].[usp_LC_GET_Listings_for_Approval_dl]  
...
GO
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Listings_for_Approval_dl] TO [iisLpAdminFull]
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Listings_for_Approval_dl] TO [iisLpAdminSsUiFull]
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Listings_for_Approval_dl] TO [iisReviewEngine]
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Listings_for_Approval_dl] TO [iisReviewEngineFull]
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Listings_for_Approval_dl] TO [lcssui]
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Listings_for_Approval_dl] TO [LocalConnect]
GRANT EXECUTE ON  [dbo].[usp_LC_GET_Listings_for_Approval_dl] TO [web_user]
GO
