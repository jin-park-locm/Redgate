CREATE TABLE [dbo].[tblLP_BusListing_DELs]
(
...
[szTitleSearch] [varchar] (150) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[szTitleStrip] [varchar] (150) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[DtDeleted] [datetime] NOT NULL CONSTRAINT [DF__tblLP_Bus__DtDel__1EB1DD85] DEFAULT (getdate()),
[Machine] [varchar] (200) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__tblLP_Bus__Machi__1FA601BE] DEFAULT ((suser_sname()+'@')+host_name())
) ON [PRIMARY]
GO
