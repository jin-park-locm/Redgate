CREATE TABLE [dbo].[tblLP_productCampaign_RArch]
(
...
GO
GRANT SELECT ON  [dbo].[tblLP_productCampaign_RArch] TO [lcssui]
GRANT SELECT ON  [dbo].[tblLP_productCampaign_RArch] TO [web_user]
GO
