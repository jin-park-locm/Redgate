...
GO
CREATE NONCLUSTERED INDEX [idx_zipcodes_cityname] ON [dbo].[zipcodes_bak] ([CityName]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [idx_zipcodes_stateabbr] ON [dbo].[zipcodes_bak] ([StateAbbr]) ON [PRIMARY]
GO
CREATE CLUSTERED INDEX [idx_zipcodes_zipcode] ON [dbo].[zipcodes_bak] ([ZIPCode]) ON [PRIMARY]
GO
