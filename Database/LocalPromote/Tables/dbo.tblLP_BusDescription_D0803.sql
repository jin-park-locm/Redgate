CREATE TABLE [dbo].[tblLP_BusDescription_D0803]
(
[RIDAX] [int] NULL,
[RID] [int] NULL,
...
GO
GRANT SELECT ON  [dbo].[tblLP_BusDescription_D0803] TO [lcssui]
GRANT SELECT ON  [dbo].[tblLP_BusDescription_D0803] TO [web_user]
GO
