CREATE TABLE [dbo].[tblLP_ProductCampaign_BC]
(
...
[szSpecialDesc] [varchar] (60) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
GO
GRANT SELECT ON  [dbo].[tblLP_ProductCampaign_BC] TO [lcssui]
GRANT SELECT ON  [dbo].[tblLP_ProductCampaign_BC] TO [web_user]
GO
