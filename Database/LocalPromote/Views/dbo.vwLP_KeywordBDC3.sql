...
CREATE VIEW dbo.vwLP_KeywordBDC3
AS
SELECT DISTINCT 
...
FROM         ListingStoreMaster.dbo.glb_tbl_KeywordDNA INNER JOIN
                      dbo.glb_tbl_BDC ON ListingStoreMaster.dbo.glb_tbl_KeywordDNA.BDC = dbo.glb_tbl_BDC.DisplayBDC
WHERE     (dbo.glb_tbl_BDC.sActive = 'Y')
GO
GRANT SELECT ON  [dbo].[vwLP_KeywordBDC3] TO [iisLpAdminFull]
GRANT SELECT ON  [dbo].[vwLP_KeywordBDC3] TO [iisLpAdminSsUiFull]
GRANT SELECT ON  [dbo].[vwLP_KeywordBDC3] TO [iisReviewEngineFull]
GRANT SELECT ON  [dbo].[vwLP_KeywordBDC3] TO [lcssui]
GRANT SELECT ON  [dbo].[vwLP_KeywordBDC3] TO [web_user]
GO
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'vwLP_KeywordBDC3', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'vwLP_KeywordBDC3', NULL, NULL
GO
