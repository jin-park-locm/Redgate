...
CREATE View [dbo].[vw_localpromocontent2]
AS
...
GO
GRANT SELECT ON  [dbo].[vw_localpromocontent2] TO [iisLpAdminFull]
GRANT SELECT ON  [dbo].[vw_localpromocontent2] TO [iisLpAdminSsUiFull]
GRANT SELECT ON  [dbo].[vw_localpromocontent2] TO [iisReviewEngineFull]
GRANT SELECT ON  [dbo].[vw_localpromocontent2] TO [lcssui]
GRANT SELECT ON  [dbo].[vw_localpromocontent2] TO [web_user]
GO
